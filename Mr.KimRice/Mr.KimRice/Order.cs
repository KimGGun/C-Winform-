...
namespace Mr.KimRice
{
    ...
    public partial class Order : Form
    {
        ...
        public Main new_Form1 = new Main();
        ...
        private void count_order_Click(object sender, EventArgs e)
        {
            Count newCount = new Count(this);
            newCount.Show();
        }
    }
}
